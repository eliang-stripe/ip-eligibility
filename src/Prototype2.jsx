...
const RadioOption = ({ value, selectedValue, onChange, label, description }) => (
  <button
  ...
  >
    ...
    <div className="flex-1">
      <div className={`font-semibold text-sm ${selectedValue === value ? 'text-indigo-600' : 'text-gray-800'}`}>
        {label}
      </div>
        ...
        <div className="flex-1 p-6">
          ...
          <div className="border-b border-gray-200 mb-6">
            <div className="flex space-x-6">
              <button className="py-3 px-2 border-b-2 border-transparent text-sm font-semibold text-gray-500">External accounts</button>
              <button className="py-3 px-2 border-b-2 border-transparent text-sm font-semibold text-gray-500">Statement descriptor</button>
              <button className="py-3 px-2 border-b-2 border-indigo-600 text-sm font-semibold text-indigo-600">Instant payouts</button>
              <button className="py-3 px-2 border-b-2 border-transparent text-sm font-semibold text-gray-500">Multi-currency settlement</button>
            </div>
          </div>
          ...
          <div className="space-y-10">
            ...
            <div className="flex space-x-10">
              <div className="w-[300px] space-y-1">
                ...
                <p className="text-sm text-gray-500">Select which accounts are eligible for Instant Payouts.</p>
              </div>
              <div className="max-w-[650px] space-y-4">
                <RadioOption
                  ...
                  label="Specify eligibility criteria"
                  description="Only accounts that match all of the criteria you set will be eligible for Instant Payouts."
                />

                {/* Criteria Options - only show when criteria is selected */}
                {audienceType === 'criteria' && (
                  <div className="ml-7 space-y-3 pl-4">
                    <Checkbox
                      checked={accountAge}
                ...
                {audienceType === 'criteria' && (
                  <div className="ml-7 text-sm text-gray-700 p-4 bg-gray-100 rounded-md">
                    <button
                ...
                {audienceType === 'selected' && (
                  <div className="ml-7 text-sm text-gray-700">
                    You can manually set eligibility for any account from their account details page. <span className="text-indigo-600 cursor-pointer hover:text-indigo-800">Learn more</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex space-x-10">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-700">
                  Customize a monetization strategy for Instant Payouts in <span className="text-indigo-600 cursor-pointer hover:text-indigo-800">Platform pricing</span>.
                </p>
              </div>
            </div>
          </div>
