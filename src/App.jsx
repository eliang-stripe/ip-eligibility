...
function App() {
  ...
  const filterEligibleAccounts = () => {
    if (audienceType === 'all') {
      return connectedAccountsData.length
    }

    const filteredAccounts = connectedAccountsData.filter(account => {
            ...
            <div className="flex space-x-10">
              ...
              <div className="w-[500px]">
                <RadioGroup
                  ...
                  options={[
                    { value: 'all', label: 'All accounts', description: 'All current and new accounts will have access.' },
            ...
            <div className="flex space-x-10">
              <div className="w-[300px] space-y-1">
                ...
                <p className="text-sm text-gray-500">
                  {audienceType === 'all'
                    ? 'All current and new accounts will have access to Instant Payouts.'
                ...
                {audienceType === 'eligible' && (
                  <div className="space-y-4">
                    ...
                    <Checkbox
                      ...
                      label="Accounts with payout volume above"
                      showInput={true}
                    ...
                    <Checkbox
                      ...
                      label="Accounts with number of payouts above"
                      showInput={true}
                ...
                <div className="space-y-2.5">
                  <p className="text-sm text-gray-700">
                    {audienceType === 'all'
                      ? (
                        <>
                          <span className="text-indigo-600">{connectedAccountsData.length} accounts</span> are eligible. You can manually disable eligibility as needed.
                        </>
                      )
                      : (
                        <>
                          Based on these rules, <span className="text-indigo-600">{eligibleAccountsCount} accounts</span> are eligible. You can manually override eligibility as needed.
                        </>
                      )
                    }
                  </p>
